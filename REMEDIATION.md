...
4. Continue bounded Sol batches from the current ledger. [PR177](https://github.com/ronchak/Koaryu/pull/177) removes 185 lines and seven cases from the records UI source-test file, retaining five narrow policies. Together with PR176, those test/helper changes net 70 fewer lines. This is partial FT1-11 progress; the broader source-test inventory remains open. See the [accounting and limits](docs/remediation/records-test-reduction-plan.md).
