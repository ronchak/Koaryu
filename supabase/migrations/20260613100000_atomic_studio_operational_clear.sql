-- ==========================================
-- Koaryu v1 - Atomic studio operational clear
-- ==========================================
--
-- Demo reset and studio clear both delete across a wide surface. Keep those
-- destructive deletes in one database transaction instead of issuing many
-- independent backend calls.
