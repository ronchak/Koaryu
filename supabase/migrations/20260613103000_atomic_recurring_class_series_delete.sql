-- ==========================================
-- Koaryu v1 - Atomic recurring class series delete
-- ==========================================
...
BEGIN
    ...
    v_series_end_date := v_session.date - 1;
...
REVOKE ALL ON FUNCTION public.delete_recurring_class_series_atomic(UUID, UUID, UUID) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.delete_recurring_class_series_atomic(UUID, UUID, UUID) TO service_role;
