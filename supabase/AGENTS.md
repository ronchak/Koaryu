...
- The local verifier replays all 137 migrations and 51 verification files. It checks actual V38-to-V39 membership, V39-to-V40 rank-history, V40-to-V41 payer-balance, and V41-to-V42 independent program-date backup/restore upgrades with synthetic rows and retained backend contracts. The V41-to-V42 proof compares canonical and logically restored evidence and checks old/new date continuation without a backfill. The restore, rank-concurrency, and payer-concurrency tools share strict PostgreSQL 17 target validation and accept only the verifier's disposable Unix-socket cluster. Never pass them a hosted target or a production dump.
