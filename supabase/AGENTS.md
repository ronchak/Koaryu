...
- The local verifier also checks a V38 logical backup through the V39 membership upgrade with synthetic rows and both old readiness contracts. Its Python restore helper accepts only the verifier's disposable Unix-socket cluster; never pass it a hosted target or a production dump.
