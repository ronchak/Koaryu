...
- The local verifier checks actual V38-to-V39 membership and V39-to-V40 rank-history backup/restore upgrades, with synthetic rows and retained backend contracts. The restore and rank-concurrency tools share strict PostgreSQL 17 target validation and accept only the verifier's disposable Unix-socket cluster. Never pass them a hosted target or a production dump.
