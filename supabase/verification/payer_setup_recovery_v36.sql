...
BEGIN
 ...
 END IF;
 IF (v_current_count=132 AND v_current_head='20260902001000') OR (v_current_count=133 AND v_current_head='20260905022339') OR (v_current_count=134 AND v_current_head='20260908080420') OR ((v_current_count=135 AND v_current_head='20260908133504') OR ((v_current_count=136 AND v_current_head='20260908183744') OR ((v_current_count=137 AND v_current_head='20260910084231') OR (v_current_count=138 AND v_current_head='20260910093958')))) THEN
  IF private.koaryu_release_operational_contract_v29()
     ...
     OR private.koaryu_release_operational_manifest_v10()
      IS DISTINCT FROM (CASE WHEN (v_current_count=135 AND v_current_head='20260908133504') OR ((v_current_count=136 AND v_current_head='20260908183744') OR ((v_current_count=137 AND v_current_head='20260910084231') OR (v_current_count=138 AND v_current_head='20260910093958'))) THEN 'ec8605a828e82b738ce973627a8018735c28176399b7e9856aa0dd66a04b667a' ELSE 'e81893193bc199a3911d83ce0546d6458fdc4e63d34c05a1a8dd121da8087012' END)
     ...
     OR private.koaryu_release_operational_manifest_v11()
      IS DISTINCT FROM (CASE WHEN (v_current_count=135 AND v_current_head='20260908133504') OR ((v_current_count=136 AND v_current_head='20260908183744') OR ((v_current_count=137 AND v_current_head='20260910084231') OR (v_current_count=138 AND v_current_head='20260910093958'))) THEN '2efb0b2cf73beabfb219dd3642a824714c1b0619c5498ecf195071f929e651f6' ELSE '43bb07edfbd3c6ee1431b6abda46ca1785b8ea117de2a13f95636fc7a3c3b263' END)
     OR private.koaryu_release_resource_ownership_manifest_v31()
      IS DISTINCT FROM (CASE WHEN ((v_current_count=137 AND v_current_head='20260910084231') OR (v_current_count=138 AND v_current_head='20260910093958')) THEN '0:49fb66b782a732d495428e62c88ae227f32ef4c22be6d41a4cac0ff686f81e48'
          WHEN (v_current_count=135 AND v_current_head='20260908133504') OR ((v_current_count=136 AND v_current_head='20260908183744') OR ((v_current_count=137 AND v_current_head='20260910084231') OR (v_current_count=138 AND v_current_head='20260910093958'))) THEN '0:fda64c2e37a0e6efd3c69b1167fc2056fc53b85042ced46d511312c886a961a4'
     ...
     OR private.koaryu_release_operational_contract_v31()
      IS DISTINCT FROM (CASE WHEN ((v_current_count=137 AND v_current_head='20260910084231') OR (v_current_count=138 AND v_current_head='20260910093958')) THEN '0:168cc61b730cae592edaecdd15ca126ad891d6ed70bd5d523362693c662e2888'
          WHEN (v_current_count=135 AND v_current_head='20260908133504') OR ((v_current_count=136 AND v_current_head='20260908183744') OR ((v_current_count=137 AND v_current_head='20260910084231') OR (v_current_count=138 AND v_current_head='20260910093958'))) THEN '0:9f037cc4464637876016f47584d44910a6e175b2358eecb44486779273e75510'
     ...
     OR private.koaryu_release_operational_manifest_v12()
      IS DISTINCT FROM (CASE WHEN ((v_current_count=137 AND v_current_head='20260910084231') OR (v_current_count=138 AND v_current_head='20260910093958')) THEN '9f3190acf304988b74da920b85a8e1cdb6a62eb8615017788b057b477667e5a2'
          WHEN (v_current_count=135 AND v_current_head='20260908133504') OR ((v_current_count=136 AND v_current_head='20260908183744') OR ((v_current_count=137 AND v_current_head='20260910084231') OR (v_current_count=138 AND v_current_head='20260910093958'))) THEN '27cb3807a6ff60653fc0c7423428710a2c01d9254c1e5f59c0e2cb16c37f4d26'
 ...
 IF v_v31_expectation_state IS DISTINCT FROM (CASE
      WHEN ((v_current_count=137 AND v_current_head='20260910084231') OR (v_current_count=138 AND v_current_head='20260910093958')) THEN '1:9f8cfdaa076ac36d3d1b827e4c50e17c8a9796150dac84ef3b2f62360893bd18'
      WHEN (v_current_count=135 AND v_current_head='20260908133504') OR ((v_current_count=136 AND v_current_head='20260908183744') OR ((v_current_count=137 AND v_current_head='20260910084231') OR (v_current_count=138 AND v_current_head='20260910093958'))) THEN '1:220b289851c6a5714091f59560053b1a5a5cf7c4971a431bbc04a6dd85d42802'
