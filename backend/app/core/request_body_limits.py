...
STUDENT_PHOTO_REQUEST_MAX_BYTES = STUDENT_PHOTO_MAX_BYTES + STUDENT_PHOTO_MULTIPART_ALLOWANCE_BYTES
...
CSV_IMPORT_MAPPING_JSON_MAX_BYTES = (
    CSV_IMPORT_MAX_COLUMNS * CSV_IMPORT_MAX_CELL_CHARS * JSON_MAX_ESCAPED_BYTES_PER_CHARACTER
)
