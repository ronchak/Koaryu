...
BILLING_WORKFLOWS = (
    ...
    _workflow("enrollment.cancel.period_end.schedule", routes=("schedule_enrollment_period_end",), roles=("admin", "front_desk"), operations=("connected_subscription.update",), prerequisites=("active_recurring_enrollment", "exact_subscription_quantity"), scope="connect_payments"),
    _workflow("enrollment.cancel.period_end.revoke", routes=("revoke_scheduled_enrollment_transition",), roles=("admin", "front_desk"), operations=("connected_subscription.update",), prerequisites=("scheduled_cancellation_intent", "exact_subscription_quantity"), scope="connect_payments"),
