...
EXPECTED_RELEASE_MIGRATION_COUNT = 133
EXPECTED_RELEASE_MIGRATION_HEAD = "20260905022339"
EXPECTED_RELEASE_MANIFEST_VERSION = "release-db-attestation-v38"
...
def assert_hosted_release_schema_ready() -> None:
    ...
    try:
        result = execute_required_rpc(
            client,
            "koaryu_release_schema_preflight_v19",
            {},
        )
