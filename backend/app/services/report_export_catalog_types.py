...
REPORT_SOURCE_SPECS: Final[Mapping[str, ReportSourceSpec]] = MappingProxyType(
    {
        ...
        "billing_adjustments": ReportSourceSpec(
            "billing_adjustments", "postgrest", "billing_adjustments"
        ),
        "billing_disputes": ReportSourceSpec("billing_disputes", "postgrest", "billing_disputes"),
        "billing_enrollments": ReportSourceSpec(
            "billing_enrollments", "postgrest", "student_billing_enrollments"
        ),
        "billing_invoice_items": ReportSourceSpec(
            "billing_invoice_items", "postgrest", "billing_invoice_items"
        ),
        ...
        "billing_plan_programs": ReportSourceSpec(
            "billing_plan_programs", "postgrest", "billing_plan_programs"
        ),
        ...
        "billing_subscriptions": ReportSourceSpec(
            "billing_subscriptions", "postgrest", "billing_subscriptions"
        ),
        ...
        "email_usage_events": ReportSourceSpec(
            "email_usage_events", "postgrest", "email_usage_events"
        ),
        ...
        "student_billing_enrollments": ReportSourceSpec(
            "student_billing_enrollments", "postgrest", "student_billing_enrollments"
        ),
        "student_guardians": ReportSourceSpec(
            "student_guardians", "postgrest", "student_guardians"
        ),
        "student_import_runs": ReportSourceSpec(
            "student_import_runs", "postgrest", "student_import_runs"
        ),
        "student_program_memberships": ReportSourceSpec(
            "student_program_memberships", "postgrest", "student_program_memberships"
        ),
        "students": ReportSourceSpec("students", "postgrest", "students"),
        "studio_payment_accounts": ReportSourceSpec(
            "studio_payment_accounts", "postgrest", "studio_payment_accounts"
        ),
        "studio_subscriptions": ReportSourceSpec(
            "studio_subscriptions", "postgrest", "studio_subscriptions"
        ),
