...
def build_operations_report_catalog(report_service_cls: Any) -> dict[str, CsvReport]:
    return {
        "email_usage_events": _report(
            ...
            source_keys=("email_usage_events",),
        ...
        "student_import_runs": _report(
            ...
            source_keys=("student_import_runs",),
        ...
        "staff_roles": _report(
            ...
            source_keys=("staff_roles", "staff_profiles", "auth_users"),
