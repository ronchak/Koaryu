...
class BillingInvoiceProjectionTests(unittest.TestCase):
        ...
        invoice = {
            "parent": {
                ...
                "subscription_details": {
                    "metadata": {"source": "parent", "payer_id": "payer_parent"}
                },
            },
            "lines": {
                "data": [
    ...
    def test_invoice_subscription_ids_use_direct_parent_or_single_line_values(self):
        self.assertEqual(
            invoice_subscription_id({"subscription": {"id": "sub_direct"}}), "sub_direct"
        )
        self.assertEqual(
            invoice_subscription_id(
                {
    ...
    def test_subscription_period_bounds_falls_back_to_item_range(self):
        ...
        self.assertEqual(
            subscription_period_bounds({"current_period_start": 1, "current_period_end": 2}), (1, 2)
        )
