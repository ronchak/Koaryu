...
class ReportIntelligenceAttendanceIndexTest(unittest.TestCase):
        ...
        data = {
            ...
            "attendance": [
                ...
                },
                {
                    ...
                    "student_id": "student-1",
                    "status": "present",
                    "checked_in_at": "2026-05-30T18:00:00Z",
                },
            ],
        }
    ...
    def test_student_risk_queries_scale_with_students_not_attendance_rows(self):
        def build_dataset(scale):
            ...
            for student_number in range(16 * scale):
                ...
                for visit_number in range(4):
                    ...
                    sessions.append(
                        {"id": session_id, "date": event_date.isoformat(), "status": "scheduled"}
                    )
                    attendance.append(
                        {
            ...
            counter = {}
            index = _attendance_events(
                {"sessions": sessions, "attendance": attendance}, operation_counter=counter
            )
        ...
        self.assertEqual(
            2 * small_counter["attendance_index_lookups"], large_counter["attendance_index_lookups"]
        )
