    ...
    <div className="space-y-5">
      ...
      <section className="overflow-hidden rounded-[14px] border border-border bg-surface">
        ...
        {billingPayers.length === 0 ? (
          ...
          <div key={payer.id} className="grid min-w-0 grid-cols-1 gap-3 border-b border-border px-4 py-3 text-sm last:border-b-0 md:min-h-14 md:grid-cols-[1.1fr_1fr_1fr_auto] md:items-center md:gap-4 md:py-1.5">
