...
export const PREVIEW_INVOICES: BillingInvoice[] = [
  {
    ...
    invoice_receivable_amount_cents: 0,
    currency: "usd",
  ...
  },
  {
    ...
    invoice_receivable_amount_cents: 12900,
    currency: "usd",
...
export const PREVIEW_PAYMENTS: BillingPayment[] = [
  ...
  },
  {
    ...
    refunded_amount_cents: 0,
    disputed_amount_cents: 0,
    net_collected_amount_cents: 17900,
