...
export const MOCK_ELIGIBILITY: EligibilityEntry[] = [
  {
    ...
    next_rank_name: "Blue",
    next_rank_color: "#1E90FF",
    classes_since_promo: 62,
    classes_required: 50,
    days_at_rank: 420,
    days_required: 365,
    classes_met: true,
  ...
  },
  {
    ...
    current_rank_name: "Blue",
    current_rank_color: "#1E90FF",
    next_rank_name: "Purple",
    next_rank_color: "#8B5CF6",
