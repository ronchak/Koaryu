      ...
      <div className="grid gap-4 md:grid-cols-2">
        <AccountSection title="Desktop">
          <div className="space-y-3 text-sm text-text-secondary">
            ...
            <p>
              Open Koaryu in Chrome, Edge, or Safari and use the browser install option when
              available.
            </p>
            <p>
              Chrome and Edge usually show an install icon in the address bar or under the browser
              menu.
            </p>
          </div>
        </AccountSection>
        <AccountSection title="Phone or tablet">
          <div className="space-y-3 text-sm text-text-secondary">
            ...
            <p>
              On iPhone or iPad, open Koaryu in Safari, tap Share, then choose Add to Home Screen.
            </p>
      ...
      <AccountSection title="Native app status">
        <div className="flex gap-3">
          ...
          <p className="text-sm leading-relaxed text-text-secondary">
            Koaryu is currently a responsive web app. There are no separate App Store or Play Store
            downloads yet.
          </p>
        </div>
        <div className="mt-4">
          <AccountNotice>
            For dojo demos, pin Koaryu to the device home screen and open it once before the meeting
            so the session, assets, and backend warmup are ready.
          </AccountNotice>
        </div>
      </AccountSection>
    </AccountPageShell>
