    ...
    <>
      ...
      <div className="flex-1 p-4 sm:p-8" data-settings-folio="admin-ownership">
        <div className="max-w-5xl space-y-8">
          {/* Studio info */}
          <section id="studio" className="scroll-mt-8 border-y-2 border-border bg-surface p-5" data-settings-owner="studio-admin">
            <p className="mb-1 text-[10px] font-semibold uppercase tracking-widest text-muted">Owned by studio admin · Workspace identity</p>
          ...
          <section id="programs" className="scroll-mt-8" data-settings-owner="program-admin">
            <p className="border-t-2 border-border bg-surface px-5 pt-4 text-[10px] font-semibold uppercase tracking-widest text-muted">Owned by studio admin · Curriculum structure</p>
            <ProgramsSection />
          </section>

          <section id="staff-roles" className="scroll-mt-8" data-settings-owner="access-admin">
            <p className="border-t-2 border-border bg-surface px-5 pt-4 text-[10px] font-semibold uppercase tracking-widest text-muted">Owned by studio admin · Staff access</p>
            <StaffRolesSection />
          </section>

          {/* Data section */}
          {canManageStudioData ? (
          <section id="data-controls" className="scroll-mt-8 border-y-2 border-danger/25 bg-danger/5 p-5" data-settings-owner="restricted-admin">
            <p className="mb-1 text-[10px] font-semibold uppercase tracking-widest text-danger">Restricted admin ownership · Destructive workspace actions</p>
            ...
            <section id="data-controls" className="scroll-mt-8 border-y-2 border-border bg-surface p-5" data-settings-owner="restricted-admin">
              <p className="mb-1 text-[10px] font-semibold uppercase tracking-widest text-muted">Restricted admin ownership</p>
