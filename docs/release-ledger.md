...
- Current-worktree source packet derivation used:
  ...
  ```bash
  node --input-type=module --eval 'import { verifySourceTree } from "./scripts/studio-comp-migration-rollout.mjs"; const packet = verifySourceTree(".", "105090af4820f268afac4a0842fc35dbe839a992"); console.log(JSON.stringify({ candidateSha: packet.candidateSha, migrationCount: packet.migrationCount, postHistory: packet.postHistory, sourceManifestSha256: packet.sourceManifestSha256, migration111: packet.pendingManifest.at(-1) }, null, 2));'
  ```

  It returned
  post-history `111:f23ff28f995f7a5401f7a9580481a365`, source manifest SHA-256
  `3e134288dd3c6a6f3dfc8897c40de2a4ca9a9ecc65b11e73cd8e9882ed9bafaa`, and
  migration-111 SHA-256
  `388dd33fb4d77d177f36445807a5f09def6d9fb1d4663f0b00c62e676e51f824`.
...
- Sandbox verification stop: `npm run check:supabase-contracts-local` could not
  ...
  operation. The PM's outside-sandbox run applied all 111 migrations and passed
  the operational, starting-belt, and student-rank manifests; its V17 query
  returned the pinned zero-invalid-count value above. No linked or network
  fallback was used.
