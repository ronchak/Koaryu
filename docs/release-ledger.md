...
- The durable alias now points to `READY` preview deployment `dpl_5fW7LGhrUUXv1pDXC71azn4XT6YV`. Its safe `/api/version` response reports exact PR [#53](https://github.com/ronchak/Koaryu/pull/53) head `9cfd5123b3e1e28a274432a1fccdbf446739c89b`; the protected API proxy returned backend health and preserved unauthenticated `401` denial.
