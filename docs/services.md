...
The current candidate's `/health/ready` calls the V16 schema preflight and serves
only at 130/head `20260831022021` with `release-db-attestation-v35`. It fails
