...
- an exact active-student emergency-contact completeness count, never derived from the capped bootstrap roster;
...
- Start with the current fixture catalog: Classes Today, Needs Attention, Student Pulse, Attendance, Lead Follow-ups, Promotions Due, Billing Exceptions, Revenue Due, Setup Progress, Recent Students, Saved Report, Quick Actions, and Emergency Contacts. A widget whose authoritative fact is unavailable uses an honest unavailable/source-link treatment.
