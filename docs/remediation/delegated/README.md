...
| --- | --- | --- |
| [Batch 01: billing product truth](01-billing-product-truth.md) | `CTA1-01`, `BB2-10`, `DOC1-01`, `FT1-05`, `FR1-09` | No Astra implementation prerequisite; coordinate shared files. |
| [Batch 02: operator and release documents](02-operator-and-release-docs.md) | `DOC1-02`, `DOC1-03`, `DOC1-04`, `DOC1-06`, `DOC1-07`, `DOC1-11`, `DOC1-12` | Generator prerequisite satisfied; current docs work may proceed without generator changes. |
...
The owner resumed a bounded run on September 12, then redirected priority to removing billing ownership/forwarding indirection. The presentation worker stopped before implementation; those findings remain pending. See [run plan](../budget-refactor-plan.md) for the 50-point cap and scope. The prior wind-down below is historical. See [HANDOFF](../HANDOFF.md) for the exact completed/remaining inventory. Draft PR180 parks the six-interface subset of batch08; its recipe is committed on that branch as `docs/remediation/delegated/14-dead-ui-interface-closeout.md`. It is not a new independent audit batch. The broader 149 pending Sol observations include newly transferred application work that has not yet been turned into additional recipes. Do not interpret the original twelve batches as the full current Sol backlog.
