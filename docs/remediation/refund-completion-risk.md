...
`PROGRAM-REFUND-01` is corrected by V46. Deployment is separate: production must receive the forward migration before the candidate applications. No historical financial rows or stored resource fingerprints are rewritten.
