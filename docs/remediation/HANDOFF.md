...
116 audit observations are pending: 25 Astra and 91 Sol. These are observations, not ticket or PR counts. 7 program findings, tracked separately: 5 fixed, 1 pending, 1 deferred intentionally.
<!-- ledger-counts:end -->
