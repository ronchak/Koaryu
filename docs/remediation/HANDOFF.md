...
- These two findings alone move to fixed, with derived ledger counts now 142 fixed and 120 pending. They are merged into main, **not deployed**. No deployment, database apply, migration, backup/restore, billing activation, or hosted fixture mutation occurred. Production auto-deploy remains off. Release needs separate owner authorization after the postmortem.
